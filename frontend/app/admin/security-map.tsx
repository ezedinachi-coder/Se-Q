...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, RefreshControl, Modal, Platform, BackHandler } from 'react-native';
...
// Status to color mapping - Red for emergency/responding, Blue for security
const STATUS_COLORS: Record<string, string> = {
  responding: '#EF4444', // Red - emergency/panic
  available: '#3B82F6',  // Blue - available security
  busy: '#F59E0B',       // Amber - busy
...
export default function AdminSecurityMap() {
  ...
  // Map markers - ONLY security users with compact red/blue design
  const mapMarkers = securityUsers
    ...
    .map(u => ({
      ...
      // Use status color - red for responding, blue for others
...
const styles = StyleSheet.create({
  ...
  mapWrapper: { height: 260, backgroundColor: '#1E293B' },
  map: { flex: 1 },
