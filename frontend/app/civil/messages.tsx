...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, ActivityIndicator, TextInput, Modal, RefreshControl, KeyboardAvoidingView, Platform, Image, Linking } from 'react-native';
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <View style={styles.chatHeader}>
            ...
            {activeConversation.other_user?.phone && (
              <TouchableOpacity onPress={() => makePhoneCall(activeConversation.other_user?.phone)} style={{ marginRight: 12, padding: 4 }}>
